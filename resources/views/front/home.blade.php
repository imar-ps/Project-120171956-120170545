                            ...
                            <div class="col-lg-12">
                                <div class="blog-post">
                                    <div class="blog-thumb">
                                        <img src="{{asset('post_images/'.$as->Image)}}" width="250" height="250" alt="">
                                    </div>
                                    <div class="down-content">
                                        <span>{{$as->category->Name}}</span>
                                        <a href="post-details.html"><h4>{{$as->Title}}</h4></a>
                                        <ul class="post-info">
                                            <li><a href="#">Admin</a></li>
                                            <li><a href="#">{{$as->created_at}}</a></li>
                                            <li><a href="#">{{$as->Shares}} Shares</a></li>
                                        </ul>
                                        <p>{{$as->Body}}</p>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <ul class="post-tags">
                                                        ...
                                                        <li><a href="#">{{$as->category->Code}}</a></li>
                                                    </ul>
                                                </div>
                                                <div class="col-6">
                                                    <ul class="post-share">
